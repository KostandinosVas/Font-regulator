...
// Αυτό το αρχείο είναι ένα popup script για την επέκταση Font Regulator.
// Διαχειρίζεται όλες τις αλληλεπιδράσεις του UI, τις αναγνώσεις/εγγραφές αποθήκευσης,
// και την επικοινωνία με το content script.

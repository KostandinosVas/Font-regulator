...
// Αυτό το αρχείο περιέχει μονάδες δοκιμών για τη λογική απολύμανσης που χρησιμοποιείται στο content.js.
// Καλύπτει κάθε κρίσιμη διαδρομή επικύρωσης για τις ιδιότητες fontSize, fontFamily, lineHeight και color,
// καθώς και τη λίστα επιτρεπόμενων tags. Αυτές οι δοκιμές βοηθούν να διασφαλιστεί ότι η λογική απολύμανσης
// λειτουργεί σωστά και αποτρέπει πιθανές επιθέσεις XSS μέσω κακόβουλων τιμών στυλ.
